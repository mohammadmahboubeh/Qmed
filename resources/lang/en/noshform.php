...
return [
    ...
    */
    ...
    "footer1" => "This document was generated by Qmed System",
    ...
    "clear" => "Clear",
    "signature" => "Signature",
    "new_user_message" => "You are invited to use the Qmed System for",
    ...
    "password_reset1" => "This message is to notify you that you have reset your password with Qmed System",
    "password_reset2" => "To finish this process, please click on the following link or point your web browser to",
    "password_reset3" => "Reset password to Qmed System",
    ...
    "install1" => "Please fill out the entries to complete the installation of Qmed System.",
    ...
    "submit" => "Submit",
    "uma_patient_centric_designate3" => "An Authorization Server has not been found in the same domain as your Qmed System installation.",
    "uma_patient_centric_designate4" => "You will need to designate the URL of your Authorization Server to proceed with using Qmed System",
